...
- (NSURL *)productDownloadURL
{
    if ([_productDownloadURLs count] > 0)
        return [NSURL URLWithString:[_productDownloadURLs objectAtIndex:0]];
    else
        return nil;
}
...
- (void)processDictionary:(NSDictionary *)dict
{
    ...
    _productPageURL = [[NSURL URLWithString:[dict objectForKey:@"productPageURL"]] retain];
